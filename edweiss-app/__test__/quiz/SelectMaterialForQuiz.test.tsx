...
describe('SelectMaterialForQuizModal', () => {
	it('displays a scroll view of materials', () => {
		...
		const screen = render(<BottomSheetModalProvider>
			<SelectMaterialForQuizModal addToExerciseList={jest.fn()} courseId='courseId' handle={handle} modalRef={modalRef} />
