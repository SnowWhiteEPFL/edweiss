import EditAssignment, { testIDs } from '@/components/courses/EditAssignment';
...
jest.mock('@/config/i18config', () =>
    jest.fn((str: string) => {
        if (str === 'course:edit_assignment') return 'Edit Assignment';
...
describe('Edit Assignment', () => {
    ...
    it('should render the component', () => {
        const screen = render(<EditAssignment assignment={assignment} onSubmit={mockOnSubmit} onDelete={mockOnDelete} />);
